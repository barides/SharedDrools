...
public class DroolsRuleAddEventListener  {
    ...
    public DroolsRuleAddEvent addRule(DroolsRuleAddEvent droolsRuleAddEvent) {
		...
		try {
            ...
            if(knowledgeBaseWrapper == null) {
            	knowledgeBaseWrapper = createKnowledgeBaseWrapper(ruleSet,droolsRuleAddEvent.getRouting());
            }
            
            KnowledgePackage knowledgePackage = knowledgePackageDao.read(ruleSet, knowledgePackageName);
            if(knowledgePackage == null) {
            	knowledgePackage = createKnowledgePackage(knowledgeBaseWrapper, knowledgePackageName, ruleSet,droolsRuleAddEvent.getRouting());
            }
	...
	private KnowledgeBaseWrapper createKnowledgeBaseWrapper(String ruleSet, Integer routing) {
	    ...
	    knowledgeBaseWrapper.setRouting(routing);
    ...
    private KnowledgePackage createKnowledgePackage(KnowledgeBaseWrapper knowledgeBaseWrapper, String knowledgePackageName, String ruleSet, Integer routing) {
    	...
    	knowledgePackage.setRouting(routing);
    ...
    private DroolsRule createDroolsRule(DroolsRuleAddEvent droolsRuleAddEvent) {
		...
		// droolsRule.setRouting(droolsRuleAddEvent.getRouting());
